...
if torch is not None:
    from autoencoders import build_mlp_backbone_kwargs_from_model_config, HierarchicalVectorQuantizedAutoencoderConfig, HierarchicalVectorQuantizedAutoencoderModel
