...
if torch is not None:
    from autoencoders import build_mlp_backbone_kwargs_from_model_config, GumbelQuantizedAutoencoderConfig, GumbelQuantizedAutoencoderModel
...
class GumbelQuantizedAutoencoderModelTest(unittest.TestCase):
    ...
    def test_forward_returns_assignment_metrics(self) -> None:
        model = GumbelQuantizedAutoencoderModel(self.config, **build_mlp_backbone_kwargs_from_model_config(self.config))
