...
if torch is not None:
    from autoencoders import build_mlp_backbone_kwargs_from_model_config, MMDVariationalAutoencoderConfig, MMDVariationalAutoencoderModel
...
class MMDVariationalAutoencoderModelTest(unittest.TestCase):
    ...
    def test_forward_returns_mmd_loss(self) -> None:
        model = MMDVariationalAutoencoderModel(self.config, **build_mlp_backbone_kwargs_from_model_config(self.config))
